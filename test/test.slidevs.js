...
describe('Creating a new Slidevs', function() {
        ...
        it('Should return a correct Slidevs object', function() {
        ...
        it('Should create a Slidevs with the right inserted options, with and without slashes and extentions', function() {
